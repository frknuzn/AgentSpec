...
function getLogFilePath(): string {
  ...
  // Dev mode uses "AgentSpec-Dev", production uses "AgentSpec"
  const devPath = path.join(os.homedir(), 'Library', 'Logs', 'AgentSpec-Dev', `${today}.log`);
  const prodPath = path.join(os.homedir(), 'Library', 'Logs', 'AgentSpec', `${today}.log`);
