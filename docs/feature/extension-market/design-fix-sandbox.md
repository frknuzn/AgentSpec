...
> PR：[#1991](https://github.com/iOfficeAI/AgentSpec/pull/1991) (问题 1-3)
> Issue：[#1990](https://github.com/iOfficeAI/AgentSpec/issues/1990)
...
JSON 文件 KV 存储，每个扩展一个文件 `~/.agentspec/extension-storage/{name}.json`：
