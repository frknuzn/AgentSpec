...
describe('extractWebSocketToken – cookie parsing with special characters', () => {
  ...
  it('prefers Authorization header over cookie', () => {
    const req = fakeReq({
      ...
      cookie: 'agentspec-session=cookietoken',
    });
