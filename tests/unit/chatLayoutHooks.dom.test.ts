...
vi.mock('@/renderer/utils/workspace/workspaceEvents', () => ({
  WORKSPACE_TOGGLE_EVENT: 'agentspec-workspace-toggle',
  WORKSPACE_STATE_EVENT: 'agentspec-workspace-state',
  WORKSPACE_HAS_FILES_EVENT: 'agentspec-workspace-has-files',
...
describe('useWorkspaceCollapse', () => {
  const STORAGE_KEY = 'agentspec_workspace_panel_collapsed';
