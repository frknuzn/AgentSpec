...
const ENV_KEYS = ['AGENTSPEC_HTTPS', 'HTTPS', 'NODE_ENV', 'SERVER_BASE_URL'] as const;
...
describe('getCookieOptions', () => {
  ...
  it('issues Secure + SameSite=None when AGENTSPEC_HTTPS=true', () => {
    process.env.AGENTSPEC_HTTPS = 'true';
