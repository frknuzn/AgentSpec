...
| ---------------------------- | ----- | ------------------------ |
| `AGENTSPEC_E2E_TEST`            | `1`   | App recognizes test mode |
| `AGENTSPEC_DISABLE_AUTO_UPDATE` | `1`   | No update checks         |
| `AGENTSPEC_DISABLE_DEVTOOLS`    | `1`   | No DevTools windows      |
| `AGENTSPEC_CDP_PORT`            | `0`   | CDP disabled             |
...
```bash
# Clean via database
sqlite3 "~/Library/Application Support/AgentSpec-Dev/agentspec/agentspec.db" \
