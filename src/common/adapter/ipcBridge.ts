...
export interface IStartOnBootStatus {
  ...
  supported: boolean;
  /** Whether AgentSpec is currently configured to launch at login */
  enabled: boolean;
...
export const fs = {
  ...
  // Skills Market: inject/remove the agentspec-skills builtin skill
...
export const deepLink = {
  /** Emitted when app is opened via agentspec:// protocol URL */
