...
export const WORKSPACE_EXPANSION_STORAGE_KEY = 'agentspec_workspace_expansion';
export const WORKSPACE_EXPANSION_EVENT = 'agentspec:workspace-expansion-changed';
