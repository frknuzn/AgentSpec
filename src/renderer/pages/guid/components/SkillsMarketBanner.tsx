...
const SKILLS_MARKET_DETAILS_ZH = 'https://github.com/iOfficeAI/AgentSpec/discussions/1326';
const SKILLS_MARKET_DETAILS_EN = 'https://github.com/iOfficeAI/AgentSpec/discussions/1325';
