...
export const BUILTIN_IMAGE_GEN_NAME = 'agentspec-image-generation';
export const BUILTIN_IMAGE_GEN_LEGACY_NAMES = ['AgentSpec Image Generation', BUILTIN_IMAGE_GEN_ID] as const;
