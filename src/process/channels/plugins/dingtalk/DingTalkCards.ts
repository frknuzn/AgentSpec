...
export function createMainMenuCard(): DingTalkCard {
  return {
    title: 'AgentSpec Assistant',
    text: '### AgentSpec Assistant\n\nWelcome! Choose an action below:',
    btnOrientation: '1',
    btns: [
...
export function createPairingCard(pairingCode: string): DingTalkCard {
  return {
    ...
    text: [
      '### Pairing Required',
      '',
      'Please pair your account with AgentSpec:',
      '',
      `**Pairing Code:** \`${pairingCode}\``,
      '',
      '1. Open AgentSpec settings',
...
export function createPairingStatusCard(pairingCode: string): DingTalkCard {
  return {
    ...
    text: [
      ...
      `**Pairing Code:** \`${pairingCode}\``,
      '',
      'Please approve in AgentSpec settings:',
      '1. Open AgentSpec app',
...
export function createHelpCard(): DingTalkCard {
  return {
    title: 'AgentSpec Assistant Help',
    text: [
      '### AgentSpec Assistant Help',
      '',
      'A remote assistant to interact with AgentSpec via DingTalk.',
      '',
      '**Common Actions:**',
...
export function createPairingGuideCard(): DingTalkCard {
  return {
    ...
    text: [
      ...
      '3. Approve pairing in AgentSpec settings',
...
export function createSettingsCard(): DingTalkCard {
  return {
    ...
    text: [
      '### Settings',
      '',
      'Channel settings need to be configured in the AgentSpec app.',
      '',
      'Open AgentSpec > WebUI > Channels',
    ].join('\n'),
