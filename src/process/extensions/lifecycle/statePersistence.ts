...
const EXTENSION_STATES_FILE_ENV = 'AGENTSPEC_EXTENSION_STATES_FILE';
 ...
 * Stored under getDataPath(): ~/.agentspec/extension-states.json (Electron release),
 * ~/.agentspec-dev/extension-states.json (Electron macOS dev), or the platform-standard
 * app data dir on Windows/Linux. Can be overridden via AGENTSPEC_EXTENSION_STATES_FILE.
 */
