 ...
 *   - macOS:   ~/Library/Logs/AgentSpec/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\AgentSpec\logs\YYYY-MM-DD.log
 *   - Linux:   ~/.config/AgentSpec/logs/YYYY-MM-DD.log
 *
