...
export const PROTOCOL_SCHEME = 'agentspec';

/**
 * Parse an agentspec:// URL into action and params.
 * Supports two formats:
 *   1. agentspec://add-provider?baseUrl=xxx&apiKey=xxx
 *   2. agentspec://provider/add?v=1&data=<base64 JSON>  (one-api / new-api style)
 */
